...
#define SEAM_CAVE_GRA_WEIGHT 0
#define SEAM_CAVE_GRA_BRIGHT 1
#define SEAM_CAVE_GRA_BRIGHT_AVG 2
#define SEAM_CAVE_GRA_SOBEL	3
#define SEAM_CAVE_GRA_LAPLACE 4
#define SEAM_CAVE_GRA_CANNY 5
...
public:
	...
	//三个数中最小的数
	static int getMin(int r,int g,int b);
	...
	//HSV
	static void neoHSVGradient(const IplImage* src,IplImage *gra);
	//weight
	static void neoWeightGradient(const IplImage* src,IplImage *gra);
	...
	static void nSeamCarvingLargeYouHua(IplImage *img,IplImage *mask,IplImage *mask2,IplImage *gra,IplImage *dis,int height,int width);
